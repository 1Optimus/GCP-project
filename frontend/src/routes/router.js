  ...
  return (
    ...
    <div>
        ...
        <Switch>
            ...
            <Route exact path="/app" comp={AppScreen} />
            <Route exact path="/favorites" comp={FavoritesScreen} />
            <Route exact path="/album" comp={AlbumScreen} />
            <Route exact path="/profile" comp={ProfileScreen} />
            <Route exact path="/album/:idAlbum" comp={AlbumImagesScreen} />
            <Route exact path="/app/images" comp={AddImages} />
